...
const Login = () => {
  ...
  return (
    <div className='bg-cover bg-center min-h-screen flex  justify-center items-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      {/* Left section */}
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {
          currState === "Sign Up" && isDataSubmitted && (
            <textarea onChange={(e) => setBio(e.target.value)} value={bio} rows={4} required
              className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-indigo-500' placeholder='provide a short bio...'
            ></textarea>
          )
        }
