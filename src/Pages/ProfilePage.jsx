...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center max-sm:flex-col-reverse justify-between  rounded-lg'>
        ...
        <img className={`max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 ${selectedImg && 'rounded-full'}`} src={authUser.profilePic ? authUser.profilePic : assets.logo_icon} alt="" />
      </div>
    </div>
  )
}
